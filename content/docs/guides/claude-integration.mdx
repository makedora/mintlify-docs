...
<Warning>
This page covers Claude credentials **inside sandboxes**. For authenticating API requests to Yolocode, see [Authentication](/docs/guides/authentication) — you need a GitHub token, not a Claude token.
</Warning>
